...
import projects.qnum_congestion_ctrl.messages as messages
from projects.qnum_congestion_ctrl.congestion_controller import CongestionController
from projects.qnum_congestion_ctrl.queues import RequestQueue, LLEManager
...
class QuantumNode(SimpleModule):
    ...
    def __init__(self, name, identifier, storage_qbits_per_port=None):
        ...
        self.timeout_trigger_period = 100  # us
        self.last_update_time = 0
        self.last_congested_time = 0
        ################################
    ...
    def _handle_flows_information(self, message):
        ...
        for flow_id in relevant_flows:
            ...
            flow_info[flow_id] = {
                "request_rate": flow["request_rate"],  # not used in this version
                "next_port": next_port,
                "source": flow["source"],
